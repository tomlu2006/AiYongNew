...
public class ToastUtil {
    ...
    private static Toast makeToast() {
        Toast toast = new Toast(MhDataManager.getInstance().getContext());
        toast.setDuration(Toast.LENGTH_SHORT);
        toast.setGravity(Gravity.CENTER, 0, 0);
        View view = LayoutInflater.from(MhDataManager.getInstance().getContext()).inflate(R.layout.view_toast, null);
        toast.setView(view);
        return toast;
    }
