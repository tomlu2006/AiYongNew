                ...
                if (code == 0 && info.length > 0) {
                    ...
                    if (mCheckLivePresenter == null) {
                        mCheckLivePresenter = new LiveRoomCheckLivePresenter(mContext, new LiveRoomCheckLivePresenter.ActionListener() {
                            @Override
                            public void onLiveRoomChanged(LiveBean liveBean, int liveType, int liveTypeVal, int liveSdk, boolean isVoiceRoom) {
                                if (liveBean == null) {
                                    return;
                                }
                                ...
                                if (mFromLiveRoom) {
                                    ...
                                    LiveAudienceActivity.forward(mContext, liveBean, liveType, liveTypeVal, "", 0, liveSdk, isVoiceRoom);
                                }
                            }
                        });
                    }
