...
public class MainListAdapter extends RefreshAdapter<ListBean> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == HEAD) {
            if (mHeadVh == null) {
                mHeadVh = new HeadVh(mInflater.inflate(mType == TYPE_PROFIT ? R.layout.item_main_list_head : R.layout.item_main_list_head_con, parent, false));
            }
            return mHeadVh;
        } else {
        ...
        void setData(Object payload) {
            ...
            if (topSize > 0) {
                ...
                if (payload == null) {
                    ...
                    mVotes1.setText(StringUtil.contact(bean.getTotalCoinFormat(), " ", mCoinName));
            ...
            if (topSize > 1) {
                ...
                if (payload == null) {
                    ...
                    mVotes2.setText(StringUtil.contact(bean.getTotalCoinFormat(), " ", mCoinName));
            ...
            if (topSize > 2) {
                ...
                if (payload == null) {
                    ...
                    mVotes3.setText(StringUtil.contact(bean.getTotalCoinFormat(), " ", mCoinName));
