...
//                if (width >= height) {
//                    txVideoView.setScaleX(1);
//                    txVideoView.setScaleY(1);
//                } else {
//                    float screenW = ScreenDimenUtil.getInstance().getScreenWdith();
//                    float screenH = ScreenDimenUtil.getInstance().getScreenHeight();
//                    float screenRatio = screenH / screenW;
//                    float streamRatio = height / width;
//                    float scale = screenRatio / streamRatio;
//                    L.e(TAG, "scale----scale---> " + scale);
//                    txVideoView.setScaleX(scale);
//                    txVideoView.setScaleY(scale);
//                }
