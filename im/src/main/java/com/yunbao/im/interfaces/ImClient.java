...
public interface ImClient {
     ...
     * 获取图片文件
     */
    void displayImageFile(Context context, ImMessageBean bean, CommonCallback<File> commonCallback,boolean thumbnail);
     ...
     * 撤回消息
     */
    void retractMessage(String toUid, Message message);
}
