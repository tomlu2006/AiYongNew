...
public class JimMessageUtil implements ImClient {
    ...
    public void init() {
        ...
        JMessageClient.setNotificationFlag(JMessageClient.FLAG_NOTIFY_DISABLE);//收到消息不显示通知栏
    }
